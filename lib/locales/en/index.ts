const en = {
  ...
  CLAIMED: "Claimed",
  CLAIMABLE: "Claimable",
  VE_YMT_REWARD: "{{veTokenName}} Rewards",
  VE_YMT_REWARD_HELP:
  ...
  YMT_LOCKED: "{{tokenName}} Locked",
  LOCKED_UNTIL: "Locked until",
  REWARDS: "Rewards",
  REWARDS_HELP:
    "As a reward for {{veTokenName}} holders, newly issued {{tokenName}} and fee income are distributed according to the amount of {{veTokenName}} held at the start of each week.",
  ...
  TOTAL_YMT: "Total {{tokenName}} supply",
  TOTAL_YMT_VOTE_LOCKED: "Total vote-locked {{tokenName}}",
  PERCENTAGE_YMT_LOCKED: "Percentage of {{tokenName}} locked",
  TOTAL_VE_YMT: "Total {{veTokenName}}",
};
export default en;