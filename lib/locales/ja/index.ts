const ja = {
  ...
  EARLY_USER_REWARD_HELP:
    "初期リワードの量は、2024年〇月〇日〇時からスタートし、その時点では0%です。時間が経過するにつれ、この報酬の量は徐々に増加し、2025年〇月〇日〇時には、全額の100%を受け取ることが可能になります。この増加は時間が経つにつれて均一で、報酬の受け取り可能量は直線的に増えていきます。",
  ALLOCATED: "割当量",
  CLAIMED: "請求済み",
  CLAIMABLE: "請求可能",
  VE_YMT: "veYMT",
  ...
  VE_YMT_REWARD_HELP:
    "YMTを一定期間ロックすることで、移転不可のveYMTを発行します。ロック期間の最小単位は1週間、最大期間は4年間（208週）で、ロックしたYMTはロック期間終了まで引き出しできません。\n1YMTを4年間ロックすると1veYMTが発行され、時間経過により線形に減衰し、4年後に0veYMTになります。",
  YMT_LOCKED: "ロック中のYMT",
