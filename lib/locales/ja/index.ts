const ja = {
  ...
  TOTAL_YMT: "{{tokenName}}総供給量",
  TOTAL_YMT_VOTE_LOCKED: "投票ロックされた{{tokenName}}の合計",
  PERCENTAGE_YMT_LOCKED: "{{tokenName}}ロックの割合",
  TOTAL_VE_YMT: "{{veTokenName}}の合計",
};
export default ja;
